...
import { TruckIcon, MagnifyingGlassIcon, PlusIcon, WrenchScrewdriverIcon } from '@heroicons/react/24/outline';
    ...
    <div className="space-y-6">
      ...
      {showForm && canWrite && (
        <form onSubmit={handleCreate} className="card grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <button type="submit" className="btn-primary sm:col-span-2">Save vehicle</button>
        </form>
      )}
